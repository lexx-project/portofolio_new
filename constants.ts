...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A comprehensive digital transition project. Designed for high availability and data integrity using a normalized SQL schema.',
  ...
  },
  {
    ...
    description: 'Automated response system handling high-volume messaging. Reducing manual communication effort by >70% through intelligent routing.',
